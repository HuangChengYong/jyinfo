      ...
      <div class="content">
        ...
        <div class="content_01">
          ...
          <div class="content_right">
            <img src="//jy-info.qicp.vip/static/kylin/1.png" alt="1.png"/>
          </div>
        </div>
        <!-- 构建统一共享的业务逻辑统一定义，重复利用 -->
        <div class="content_02">
          <div class="content_left">
            <img src="//jy-info.qicp.vip/static/kylin/2.png" alt="2.png"/>
          </div>
          <div class="content_right">
        ...
        <div class="content_03">
          ...
          <div class="content_right">
            <img src="//jy-info.qicp.vip/static/kylin/3.gif" alt="3.gif"/>
          </div>
        </div>
        <!-- 从任意数据源获取最有价值数据 -->
        ...
        <div class="content_06">
          <div class="content_left">
            <img src="//jy-info.qicp.vip/static/kylin/6.png" alt="6.png"/>
          </div>
          <div class="content_right">
      ...
      playerOptions: [
        {
          ...
          sources: [{
            type: "",
            src: "//jy-info.qicp.vip/static/kylin/4.mp4" //url地址
          }],
          poster: "//jy-info.qicp.vip/static/kylin/4.png", //你的封面地址
        ...
        },
        {
          ...
          sources: [{
            type: "",
            src: "//jy-info.qicp.vip/static/kylin/5.mp4" //url地址
          }],
          poster: "//jy-info.qicp.vip/static/kylin/5.png", //你的封面地址
          notSupportedMessage: '此视频暂无法播放，请稍后再试', //允许覆盖Video.js无法播放媒体源时显示的默认信息。
          controlBar: {
            timeDivider: true,
            durationDisplay: true,
